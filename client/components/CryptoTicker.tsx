...
function CryptoCard({
  ...
  return (
    <div
      className="flex-shrink-0 w-[260px] md:w-[280px] h-[150px] rounded-[10px] card-glass relative p-5 flex flex-col justify-between"
    >
      {/* Top row: icon + symbol */}
...
function UpArrow() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <path
        d="M6.13397 2.5C6.51887 1.83333 7.48113 1.83333 7.86603 2.5L12.1962 10C12.5811 10.6667 12.0999 11.5 11.3301 11.5H2.66987C1.90007 11.5 1.41895 10.6667 1.80385 10L6.13397 2.5Z"
        fill="#19FF00"
      />
    </svg>
  );
...
function DownArrow() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <path
        d="M7.86603 11.5C7.48113 12.1667 6.51887 12.1667 6.13397 11.5L1.80385 4C1.41895 3.33333 1.90007 2.5 2.66987 2.5L11.3301 2.5C12.0999 2.5 12.5811 3.33333 12.1962 4L7.86603 11.5Z"
        fill="#FF3B30"
      />
    </svg>
  );
...
function BnbIcon() {
  return (
    <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
      ...
      <path
        d="M12.0754 13.7984L15 10.8739L17.9259 13.7997L19.6276 12.098L15 7.47058L10.3739 12.0967L12.0755 13.7983L12.0754 13.7984ZM7.47058 15L9.17229 13.298L10.8739 14.9996L9.17217 16.7013L7.47058 15ZM12.0754 16.2017L15 19.1261L17.9259 16.2004L19.6284 17.9011L19.6276 17.902L15 22.5294L10.3739 17.9033L10.3715 17.9009L12.0756 16.2016L12.0754 16.2017ZM19.1261 15.0007L20.8278 13.299L22.5294 15.0006L20.8278 16.7023L19.1261 15.0007Z"
        fill="#F3BA2F"
      />
      <path
        d="M16.7255 14.9986H16.7262L14.9996 13.272L13.7234 14.5478L13.5768 14.6945L13.2744 14.9969L13.272 14.9993L13.2744 15.0017L14.9996 16.7271L16.7263 15.0005L16.7272 14.9995L16.7256 14.9986"
        fill="#F3BA2F"
      />
    </svg>
  );
